...
while($row = mysql_fetch_array($comments))
{
  ...
  $srNo = htmlspecialchars($row['srNo'],ENT_QUOTES);
  $source = htmlspecialchars($row['source'],ENT_QUOTES);
						...
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									...
									<span class="book-name"><?php echo "$name"?></span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
							</a>
							<a href="downloads.php?file=<?php echo "$source"?>" class="buy-btn">Download<span class="price"><img src="css/images/download.png" style="width:25px;height:35px;"></span></a>
						</div>
					</li>
...
?>
					...
					<li>
						...
						<a href="downloads.php?file=fees" class="buy-btn">Download<span class="price"><img src="css/images/download.png" style="width:25px;height:35px;"></span></a>
						</div>
					</li>
					<li>
						<div class="product">
